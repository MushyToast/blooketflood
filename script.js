(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Minesraft2/Blooket-Cheats/main/autoupdate/timestamps/global/floodGame.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1692579651640 || iframe.contentWindow.confirm(error)) cheat();
    }
